...
def create_lookup_tables(text):
    ...
    # Building a dicionary to map vocab to integers and vice versa
...
def token_lookup():
    ...
    punctuations['.'] = '||Period||'
    punctuations[','] = '||Comma||'
    #punctuations['*'] = '||Quotation Mark||'
    punctuations[';'] = '||Semi_colon||'
    punctuations['?'] = '||Question_Mark||'
    punctuations['('] = '||Left_Parentheses||'
    punctuations[')'] = '||Right_Parentheses||'
    punctuations['-'] = '||Dash||'
    punctuations['\n'] = '||Return||'
    punctuations['"'] = '||Double_Commas||'
...
def batch_data(words, sequence_length, batch_size):
    ...
    """
    # TODO: Implement function
    #print("Number of WOrds before batching ={}". format(len(words)))
...
class RNN(nn.Module):
    ...
    def forward(self, nn_input, hidden):
        ...
        print('\n batch_size value = {}'.format(batch_size))
